#  -------------------------------------------------------------
#   Copyright (c) BerryBot AI.  All rights reserved.
#  -------------------------------------------------------------
"""
Skeleton code showing how to load and run the TensorFlow SavedModel export package.
"""
import argparse
import os
import json
...
class Model(object):
    ...
    def predict(self, image: Image.Image):
        ...
        if "Image" not in self.inputs:
            raise ValueError("Couldn't find Image in model inputs - please report issue to BerryBot Admin!")
